...
int main(int argc, char** argv) {
  ...
  fputs(";;;; socket structs\n", output);
  struct sockaddr_in _sin;
  fprintf(output, "(def-foreign-type sockaddr_in (:array :unsigned-char %zu))\n", sizeof(_sin));
  struct sockaddr_in6 _sin6;
  fprintf(output, "(def-foreign-type sockaddr_in6 (:array :unsigned-char %zu))\n", sizeof(_sin6));
  struct sockaddr _sa;
  fprintf(output, "(def-foreign-type sockaddr (:array :unsigned-char %zu))\n", sizeof(_sa));
  fputs("\n\n", output);
...
#undef XX
  ...
  fprintf(output, "(defconstant +UV_EOF+ %d)\n", UV_EOF);
